...
void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOC, Shift_Enable_Pin|GPIO_PIN_9, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(Shift_Reset_GPIO_Port, Shift_Reset_Pin, GPIO_PIN_SET);

  /*Configure GPIO pins : LD2_Pin Shift_Reset_Pin */
  GPIO_InitStruct.Pin = LD2_Pin|Shift_Reset_Pin;
  ...
  /*Configure GPIO pins : Shift_Enable_Pin PC9 */
  GPIO_InitStruct.Pin = Shift_Enable_Pin|GPIO_PIN_9;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
